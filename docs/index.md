...
Airline contains only the very basic features, that almost any application needs (listed below). These features are
...
This may not sound "cool", but the goal of Airline is to be helpful when bootstrapping a new project. It contains the
...
Live demo is available on [http://airline.softwaremill.com](http://airline.softwaremill.com).
